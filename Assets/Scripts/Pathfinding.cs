...
public class Pathfinding : MonoBehaviour
{
    ...
    public void Setup(int with, int height, float cellSize)
    {
        ...
        gridSystem = new GridSystemHex<PathNode>(this.width, this.height, this.cellSize,
    ...
    public List<GridPosition> FindPath(GridPosition startGridPosition, GridPosition endGridPosition, out int pathLength)
    {
        ...
        startNode.SetHCost(CalculateHeuristDistance(startGridPosition, endGridPosition));
        ...
        while (openList.Count > 0)
        {
            ...
            foreach (PathNode neighbourNode in GetNeighbourList(currentNode))
            {
                ...
                if (tentativeGCost < neighbourNode.GetGCost())
                {
                    ...
                    neighbourNode.SetHCost(CalculateHeuristDistance(neighbourNode.GetGridPosition(), endGridPosition));
    ...
    public int CalculateHeuristDistance(GridPosition gridPositionA, GridPosition gridPositionB)
    {
